...
public class XmppMessageManager implements MessageListener, RosterListener {
	...
	public XmppMessageManager(XmppCoordinator xmppCoordinator, DeviceCoordinator deviceCoordinator){
